  ...
  <div class="container">
    <div class="row align-items-center text-white">
      ...
      <div class="col-md-6 intros text-end">
        <div class="video-box">
          <img src="frontend/images/arts/intro-section-illustration.png" alt="video illutration" class="img-fluid">
          <a href="javascript:void(0);" class="glightbox position-absolute top-50 start-50 translate-middle">
            <span>
