        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            ...
            <div class="testimonials__picture">
              <img src="frontend/images/testimonials/client-1.jpg" alt="client-1 picture" class="rounded-circle img-fluid">
            </div>
            <!-- client name & role  -->
          ...
          <div class="carousel-item">
            ...
            <!-- client picture  -->
            <div class="testimonials__picture">
              <img src="frontend/images/testimonials/client-2.jpg" alt="client-2 picture" class="rounded-circle img-fluid">
            </div>
            <!-- client name & role  -->
            <div class="testimonials__name">
              <h3>Joy Marete</h3>
          ...
          <div class="carousel-item">
            ...
            <!-- client picture  -->
            <div class="testimonials__picture">
              <img src="frontend/images/testimonials/client-3.jpg" alt="client-3 picture" class="rounded-circle img-fluid">
            </div>
            <!-- client name & role  -->
            <div class="testimonials__name">
          ...
          <div class="carousel-item">
            ...
            <!-- client picture  -->
            <div class="testimonials__picture">
              <img src="frontend/images/testimonials/client-4.jpg" alt="client-4 picture" class="rounded-circle img-fluid">
            </div>
            <!-- client name & role  -->
            <div class="testimonials__name">
